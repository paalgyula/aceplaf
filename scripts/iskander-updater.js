...
var estimation = [
  ...
  "Identification: Bravo Foxtrot Sierra",
  "Installing my Windows 10: About $time minutes reaming",
  "Building my minecraft world. It can take $time minutes...",
  "It cannot be done! I found it on stackoverflow.com in $time minutes.<br/> The guy had -192 points.",
  "I can write a Hello World application in $time minutes in Bash script",
  "I dont't know what to do",
  "It is not running on linux because I made a .BAT file",
  "Only windows is compatible with my codebase!",
  "My application is hacked in $time minutes!",
  "I can make 200K code out of thin air",
  "Please wait...<br/>I am writing a wall of text comment first in the JIRA ticket you open for me."
];
...
function reset() {
  ...
  estimateElement.innerHTML = "Please wait... I'm creating a JIRA ticket!";
}
